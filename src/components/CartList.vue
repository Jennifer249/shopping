        ...
        <div class="cart-content">
            <div class="cart-content-main" v-for="(item, index) in cartList">
                ...
                <div class="cart-delete">
                   ...
                   <span class="cart-control-delete" @click="deleteModal = true">删除</span>
                   <Modal
                        v-model="deleteModal"
                        title="消息"
                        @on-ok="ok (index)">
	...
	export default {
		...
		methods: {
			...
			handleCount (index, count) {
                if (count < 0 && this.cartList[index].count === 1) return;	//当商品数为1且为减少数量则直接返回，不操作
